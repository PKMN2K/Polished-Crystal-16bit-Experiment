...
\1Nationality:: dw
\1AuthorID::    dw
; Legacy one-byte Portrait Mail artwork hint. This is deliberately not a
; mechanical species identity: the fixed Gen II link-mail packet has no form
; or native-ID field.
\1Species::     db
\1Type::        db
\1End::
