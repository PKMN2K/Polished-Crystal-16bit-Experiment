...
endr
sHallOfFameEnd::
	assert sHallOfFame == $ad10, "Hall of Fame start has shifted."
	assert sHallOfFameEnd == $b0e4, "Legacy Hall of Fame data has shifted."

; Canonical species identities parallel the legacy fixed-width display records.
sHallOfFameNativeSpecies:: ds HOF_NATIVE_SPECIES_LENGTH
sHallOfFameNativeSpeciesEnd::
sHallOfFameNativeMagic:: dw
	assert sHallOfFameNativeMagic + 2 <= $c000, "Hall of Fame SRAM overflow."
