...
wPokedexFlags::
wPokedexCaught:: flag_array NUM_POKEDEX_FLAGS
wEndPokedexCaught::

wPokedexSeen:: flag_array NUM_POKEDEX_FLAGS
wEndPokedexSeen::
wEndPokedexFlags::
...
; Aligned conversion table mapping transient byte IDs to native species IDs.
