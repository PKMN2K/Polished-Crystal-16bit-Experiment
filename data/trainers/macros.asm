...
MACRO resolve_trainer_native_species
; Resolve a trainer's legacy species/form notation to its canonical native ID.
; The result is written to _tr_native_species. Cosmetic forms intentionally
; retain their root species ID.
	def _tr_native_species = \1
	def _tr_native_form = (\2) & SPECIESFORM_MASK
	if _tr_native_form == GYARADOS_RED_FORM && \1 == GYARADOS
		redef _tr_native_species = RED_GYARADOS
	elif _tr_native_form == MEWTWO_ARMORED_FORM && \1 == MEWTWO
		redef _tr_native_species = ARMORED_MEWTWO
	elif _tr_native_form == DUDUNSPARCE_THREE_SEGMENT_FORM && \1 == DUDUNSPARCE
		redef _tr_native_species = DUDUNSPARCE_THREE_SEGMENT
	elif _tr_native_form == TAUROS_PALDEAN_FIRE_FORM && \1 == TAUROS
		redef _tr_native_species = PALDEAN_TAUROS_BLAZE
	elif _tr_native_form == TAUROS_PALDEAN_WATER_FORM && \1 == TAUROS
		redef _tr_native_species = PALDEAN_TAUROS_AQUA
	elif _tr_native_form == URSALUNA_BLOODMOON_FORM && \1 == URSALUNA
		redef _tr_native_species = BLOODMOON_URSALUNA
	elif _tr_native_form == ALOLAN_FORM
		if \1 == RATTATA
			redef _tr_native_species = ALOLAN_RATTATA
		elif \1 == RATICATE
			redef _tr_native_species = ALOLAN_RATICATE
		elif \1 == RAICHU
			redef _tr_native_species = ALOLAN_RAICHU
		elif \1 == SANDSHREW
			redef _tr_native_species = ALOLAN_SANDSHREW
		elif \1 == SANDSLASH
			redef _tr_native_species = ALOLAN_SANDSLASH
		elif \1 == VULPIX
			redef _tr_native_species = ALOLAN_VULPIX
		elif \1 == NINETALES
			redef _tr_native_species = ALOLAN_NINETALES
		elif \1 == DIGLETT
			redef _tr_native_species = ALOLAN_DIGLETT
		elif \1 == DUGTRIO
			redef _tr_native_species = ALOLAN_DUGTRIO
		elif \1 == MEOWTH
			redef _tr_native_species = ALOLAN_MEOWTH
		elif \1 == PERSIAN
			redef _tr_native_species = ALOLAN_PERSIAN
		elif \1 == GEODUDE
			redef _tr_native_species = ALOLAN_GEODUDE
		elif \1 == GRAVELER
			redef _tr_native_species = ALOLAN_GRAVELER
		elif \1 == GOLEM
			redef _tr_native_species = ALOLAN_GOLEM
		elif \1 == GRIMER
			redef _tr_native_species = ALOLAN_GRIMER
		elif \1 == MUK
			redef _tr_native_species = ALOLAN_MUK
		elif \1 == EXEGGUTOR
			redef _tr_native_species = ALOLAN_EXEGGUTOR
		elif \1 == MAROWAK
			redef _tr_native_species = ALOLAN_MAROWAK
		endc
	elif _tr_native_form == GALARIAN_FORM
		if \1 == MEOWTH
			redef _tr_native_species = GALARIAN_MEOWTH
		elif \1 == PONYTA
			redef _tr_native_species = GALARIAN_PONYTA
		elif \1 == RAPIDASH
			redef _tr_native_species = GALARIAN_RAPIDASH
		elif \1 == SLOWPOKE
			redef _tr_native_species = GALARIAN_SLOWPOKE
		elif \1 == SLOWBRO
			redef _tr_native_species = GALARIAN_SLOWBRO
		elif \1 == FARFETCH_D
			redef _tr_native_species = GALARIAN_FARFETCH_D
		elif \1 == WEEZING
			redef _tr_native_species = GALARIAN_WEEZING
		elif \1 == MR__MIME
			redef _tr_native_species = GALARIAN_MR__MIME
		elif \1 == ARTICUNO
			redef _tr_native_species = GALARIAN_ARTICUNO
		elif \1 == ZAPDOS
			redef _tr_native_species = GALARIAN_ZAPDOS
		elif \1 == MOLTRES
			redef _tr_native_species = GALARIAN_MOLTRES
		elif \1 == SLOWKING
			redef _tr_native_species = GALARIAN_SLOWKING
		elif \1 == CORSOLA
			redef _tr_native_species = GALARIAN_CORSOLA
		endc
	elif _tr_native_form == HISUIAN_FORM
		if \1 == GROWLITHE
			redef _tr_native_species = HISUIAN_GROWLITHE
		elif \1 == ARCANINE
			redef _tr_native_species = HISUIAN_ARCANINE
		elif \1 == VOLTORB
			redef _tr_native_species = HISUIAN_VOLTORB
		elif \1 == ELECTRODE
			redef _tr_native_species = HISUIAN_ELECTRODE
		elif \1 == TYPHLOSION
			redef _tr_native_species = HISUIAN_TYPHLOSION
		elif \1 == QWILFISH
			redef _tr_native_species = HISUIAN_QWILFISH
		elif \1 == SNEASEL
			redef _tr_native_species = HISUIAN_SNEASEL
		endc
	elif _tr_native_form == PALDEAN_FORM && \1 == WOOPER
		redef _tr_native_species = PALDEAN_WOOPER
	elif _tr_native_form == PALDEAN_FORM && \1 == TAUROS
		redef _tr_native_species = PALDEAN_TAUROS_COMBAT
	endc
	assert _tr_native_species >= 1 && _tr_native_species <= NUM_NATIVE_SPECIES
ENDM

MACRO native_species_entry
; Serialize one canonical native species ID for terminated classification lists.
	if _NARG == 1
...
; Write out the party data from stored trainer buffer.
	...
	; Pokémon data
	def _tr_size += 4 ; level, native species word, form
	...
	for p, _tr_mons
		...
		resolve_trainer_native_species _tr_pk{d:p}_species, _tr_pk{d:p}_form
		dw _tr_native_species
		db _tr_pk{d:p}_form
