...
def main():
    ...
    def setup_case(native, species, form):
        ...
        for calls in (
            ...
            criticaltext_result_snapshots, supereffectivetext_calls,
    ...
    try:
        ...
        mem[normal_bank, normal_addr + 15] = 0xFE
        ...
        hook(
            ...
            lambda _: supereffectivetext_calls.append(True),
        )
        ...
        for native, species, form in cases:
            ...
            assert read_script_calls == [
                ...
                "real move-script read count around first fifteen commands",
            ...
            assert not supereffectivetext_calls, (
                "supereffectivetext executed past terminal boundary", context
            )
            assert bytes(
        ...
        print(
            f"PASS: {count} native criticaltext cases; real checkobedience -> "
            "usedmovetext -> doturn/BattleConsumePP -> hastarget -> checkhit -> "
            "checkpriority -> critical -> damagestats -> damagecalc (14) -> "
            "STAB (21) -> damagevariation (17) -> moveanim -> failuretext -> "
            "applydamage (enemy HP 83) -> real non-critical criticaltext "
            "CheckCrit + DelayFrames(20) -> sixteenth script-byte terminal "
            "boundary before supereffectivetext"
        )
    finally:
