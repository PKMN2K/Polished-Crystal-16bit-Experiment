"""Fourteenth real move-script command / applydamage native-identity regression.
...
def main():
    ...
    try:
        ...
        mem[normal_bank, normal_addr + 14] = 0xFE
        ...
        for native, species, form in cases:
            ...
            assert not criticaltext_calls, (
                "criticaltext executed past terminal boundary", context
            )
            assert bytes(
        ...
        print(
            f"PASS: {count} native applydamage cases; real checkobedience -> "
            ...
            "real applydamage (enemy HP 100 -> 83, wDamageTaken 17) -> "
            "fifteenth script-byte terminal boundary before criticaltext"
        )
    finally:
