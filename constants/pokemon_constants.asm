...
; Native 16-bit IDs for mechanically distinct variants are independent of the
; visual-form indexes advanced by ext_const/const_skip below.
DEF next_native_species_id = NUM_SPECIES + 1
MACRO native_variant
	DEF \1 EQU next_native_species_id
	REDEF next_native_species_id += 1
ENDM

; gyarados
	ext_const_def NUM_MAGIKARP + 1
	ext_const GYARADOS_RED_FORM ; 15d (15)
	native_variant RED_GYARADOS

; mewtwo
	ext_const_def 2
	ext_const MEWTWO_ARMORED_FORM ; 15e (2)
	native_variant ARMORED_MEWTWO

; dudunsparce
	ext_const_def 1, DUDUNSPARCE_TWO_SEGMENT_FORM ;     (1)
	ext_const DUDUNSPARCE_THREE_SEGMENT_FORM      ; 15f (2)
	native_variant DUDUNSPARCE_THREE_SEGMENT

; alolan forms
DEF ALOLAN_FORM EQU 2
	const_skip ; 160 rattata
	native_variant ALOLAN_RATTATA
	const_skip ; 161 raticate
	native_variant ALOLAN_RATICATE
	const_skip ; 162 raichu
	native_variant ALOLAN_RAICHU
	const_skip ; 163 sandshrew
	native_variant ALOLAN_SANDSHREW
	const_skip ; 164 sandslash
	native_variant ALOLAN_SANDSLASH
	const_skip ; 165 vulpix
	native_variant ALOLAN_VULPIX
	const_skip ; 166 ninetales
	native_variant ALOLAN_NINETALES
	const_skip ; 167 diglett
	native_variant ALOLAN_DIGLETT
	const_skip ; 168 dugtrio
	native_variant ALOLAN_DUGTRIO
	const_skip ; 169 meowth
	native_variant ALOLAN_MEOWTH
	const_skip ; 16a persian
	native_variant ALOLAN_PERSIAN
	const_skip ; 16b geodude
	native_variant ALOLAN_GEODUDE
	const_skip ; 16c graveler
	native_variant ALOLAN_GRAVELER
	const_skip ; 16d golem
	native_variant ALOLAN_GOLEM
	const_skip ; 16e grimer
	native_variant ALOLAN_GRIMER
	const_skip ; 16f muk
	native_variant ALOLAN_MUK
	const_skip ; 170 exeggutor
	native_variant ALOLAN_EXEGGUTOR
	const_skip ; 171 marowak
	native_variant ALOLAN_MAROWAK

; galarian forms
DEF GALARIAN_FORM EQU 3
	const_skip ; 172 meowth
	native_variant GALARIAN_MEOWTH
	const_skip ; 173 ponyta
	native_variant GALARIAN_PONYTA
	const_skip ; 174 rapidash
	native_variant GALARIAN_RAPIDASH
	const_skip ; 175 slowpoke
	native_variant GALARIAN_SLOWPOKE
	const_skip ; 176 slowbro
	native_variant GALARIAN_SLOWBRO
	const_skip ; 177 farfetch'd
	native_variant GALARIAN_FARFETCH_D
	const_skip ; 178 weezing
	native_variant GALARIAN_WEEZING
	const_skip ; 179 mr. mime
	native_variant GALARIAN_MR__MIME
	const_skip ; 17a articuno
	native_variant GALARIAN_ARTICUNO
	const_skip ; 17b zapdos
	native_variant GALARIAN_ZAPDOS
	const_skip ; 17c moltres
	native_variant GALARIAN_MOLTRES
	const_skip ; 17d slowking
	native_variant GALARIAN_SLOWKING
	const_skip ; 17e corsola
	native_variant GALARIAN_CORSOLA

; hisuian forms
DEF HISUIAN_FORM EQU 4
	const_skip ; 17f growlithe
	native_variant HISUIAN_GROWLITHE
	const_skip ; 180 arcanine
	native_variant HISUIAN_ARCANINE
	const_skip ; 181 voltorb
	native_variant HISUIAN_VOLTORB
	const_skip ; 182 electrode
	native_variant HISUIAN_ELECTRODE
	const_skip ; 183 typhlosion
	native_variant HISUIAN_TYPHLOSION
	const_skip ; 184 qwilfish
	native_variant HISUIAN_QWILFISH
	const_skip ; 185 sneasel
	native_variant HISUIAN_SNEASEL

; paldean forms
DEF PALDEAN_FORM EQU 5
	const_skip ; 186 wooper
	native_variant PALDEAN_WOOPER
	const_skip ; 187 tauros
	native_variant PALDEAN_TAUROS_COMBAT

; tauros
	ext_const_def 2
	ext_const TAUROS_PALDEAN_FIRE_FORM  ; 188 (2)
	ext_const TAUROS_PALDEAN_WATER_FORM ; 189 (3)
	native_variant PALDEAN_TAUROS_BLAZE
	native_variant PALDEAN_TAUROS_AQUA

; ursaluna
	ext_const_def 2
	ext_const URSALUNA_BLOODMOON_FORM ; 18a (2)
	native_variant BLOODMOON_URSALUNA

DEF NUM_NATIVE_SPECIES EQU next_native_species_id - 1
assert RED_GYARADOS == NUM_SPECIES + 1
assert ALOLAN_RATTATA == $127
assert HISUIAN_GROWLITHE == $146
assert PALDEAN_WOOPER == $14d
assert BLOODMOON_URSALUNA == $151
...
; Pokédex flags cover each native mechanical species and each cosmetic overlay.
; Their physical ordering remains save-compatible during the migration.
DEF NUM_POKEDEX_FLAGS EQU NUM_NATIVE_SPECIES + NUM_COSMETIC_FORMS
assert NUM_POKEDEX_FLAGS == NUM_UNIQUE_POKEMON
