...
DEF HOF_NATIVE_TEAM_LENGTH EQU PARTY_LENGTH * 2
DEF HOF_NATIVE_SPECIES_LENGTH EQU HOF_NATIVE_TEAM_LENGTH * NUM_HOF_TEAMS
...
DEF WILDMON_DATA_LENGTH EQU 4 ; level, native species word, form
DEF GRASS_WILDDATA_LENGTH EQU 2 + 1 + NUM_GRASSMON * WILDMON_DATA_LENGTH * 3
DEF WATER_WILDDATA_LENGTH EQU 2 + 1 + NUM_WATERMON * WILDMON_DATA_LENGTH
DEF FISHGROUP_DATA_LENGTH EQU 2 + 2 * 3
DEF FISHMON_DATA_LENGTH EQU 5 ; chance, native species word, form, level
DEF TREEMON_DATA_LENGTH EQU 5 ; chance, native species word, form, level
DEF CONTESTMON_DATA_LENGTH EQU 6 ; chance, native species word, form, min, max
