...
AddTempMonToParty:
	...
	; Keep wTempMon in the legacy representation for the Pokédex and
	; happiness work below, but store the completed party record in the
	; active persistent Pokémon-data format.
	ld hl, wPartyMon1Species
	ld a, [wPartyCount]
	dec a
	call GetPartyLocation
