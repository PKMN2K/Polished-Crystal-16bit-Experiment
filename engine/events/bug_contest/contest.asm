...
_BugContestJudging:
	...
	ld hl, wBugContestThirdPlaceMon
	call .LoadWinnerPokemonName
	ld hl, BugContest_ThirdPlaceText
	call PrintText
	ld a, [wBugContestSecondPlacePersonID]
	call LoadContestantName
	ld hl, wBugContestSecondPlaceMon
	call .LoadWinnerPokemonName
	ld hl, BugContest_SecondPlaceText
	call PrintText
	ld a, [wBugContestFirstPlacePersonID]
	call LoadContestantName
	ld hl, wBugContestFirstPlaceMon
	call .LoadWinnerPokemonName
...
.LoadWinnerPokemonName:
	ld a, [hli]
	ld b, [hl]
	farcall GetLegacySpeciesAndFormFromTransientID
...
.loop2
	...
	add hl, bc
	add hl, bc
	farcall LoadTransientSpeciesAndFormFromHL
