...
.loop
	...
	call .CopyPartyData
	call .DecodeCopiedPlayerIdentity
...
.DecodeCopiedPlayerIdentity:
; wPartyMons follows the persistent party format; this temporary OT-party
; workspace remains legacy until the opponent/battle sweep.
	push bc
	ld a, c
