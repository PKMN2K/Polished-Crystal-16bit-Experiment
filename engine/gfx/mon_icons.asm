...
GetMiniIconPointer:
	; bc = species/form on entry; hl = seven-byte visual record on return
	call GetCosmeticSpeciesAndFormIndex
	inc bc ; one-based visual ID
	ld hl, MiniIconPointers
	ld a, BANK(MiniIconPointers)
...
_GetMonIconPalette:
	...
	; bc = zero-based visual index
	call GetCosmeticSpeciesAndFormIndex
	inc bc ; one-based visual ID
	ld hl, OverworldMonIconColors
	ld a, BANK(OverworldMonIconColors)
