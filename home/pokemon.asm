...
GetDexEntryPointer::
; input: bc = zero-based legacy mechanical species index
...
GetBodyDataPointerFromIndexBC::
; in: bc = zero-based legacy mechanical species index
	inc bc
	; fallthrough
GetBodyDataPointerFromNativeIDBC::
; in: bc = one-based native species ID
; out: a:hl = body-data record pointer
	ld hl, PokemonBodyData
	ld a, BANK(PokemonBodyData)
	jp LoadIndirectPointer
...
; output: bc = extended index, carry if anything found
	farjp GetNativeSpeciesIndexFromLegacyForm
