...
; in: a = transient 8-bit ID
; out: hl = native 16-bit species index
GetPokemonIndexFromID::
	___conversion_table_homecall read, _GetPokemonIndexFromID

; in: hl = native 16-bit species index
; out: a = transient 8-bit ID
GetPokemonIDFromIndex::
	___conversion_table_homecall write, _GetPokemonIDFromIndex

; in: a = transient 8-bit ID or zero, l = lock position
LockPokemonID::
